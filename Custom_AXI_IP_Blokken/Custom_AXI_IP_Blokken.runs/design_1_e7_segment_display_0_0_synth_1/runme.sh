...
HD_PWD='C:/PXL/devWorks/devWorks2/Custom_AXI_IP_Blokken/Custom_AXI_IP_Blokken.runs/design_1_e7_segment_display_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_e7_segment_display_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_e7_segment_display_0_0.tcl
